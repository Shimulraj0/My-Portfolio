...
const GENERICS = {
  ...
  rest: { Icon: Plug, color: 'text-aqua-600 dark:text-aqua-400', label: 'REST APIs' },
  mvvm: { Icon: Layers, color: 'text-aqua-600 dark:text-aqua-400', label: 'MVVM & Provider' },
  llm: { Icon: BrainCircuit, color: 'text-aqua-600 dark:text-aqua-400', label: 'LLMs' },
  langgraph: { Icon: Network, color: 'text-aqua-600 dark:text-aqua-400', label: 'LangGraph' },
  vision: { Icon: ScanEye, color: 'text-aqua-600 dark:text-aqua-400', label: 'Computer Vision' },
  aiapps: { Icon: AppWindow, color: 'text-aqua-600 dark:text-aqua-400', label: 'AI Apps' },
  system: { Icon: Gauge, color: 'text-slate-500 dark:text-slate-400', label: 'System Management' },
  automation: { Icon: Bot, color: 'text-aqua-600 dark:text-aqua-400', label: 'AI Automation' },
  n8n: { Icon: Workflow, color: 'text-pink-500', label: 'n8n' },
  voice: { Icon: Mic, color: 'text-aqua-600 dark:text-aqua-400', label: 'Voice AI' },
  translation: { Icon: Languages, color: 'text-aqua-600 dark:text-aqua-400', label: 'Translation' },
  ...
  supabase: { Icon: Database, color: 'text-aqua-600 dark:text-aqua-400', label: 'Supabase' },
  ...
  rom: { Icon: RefreshCw, color: 'text-slate-500 dark:text-slate-400', label: 'AOSP ROMs' },
  bootloader: { Icon: Shield, color: 'text-slate-500 dark:text-slate-400', label: 'Bootloaders' },
  studio: { Icon: Code2, color: 'text-green-500', label: 'Android Studio' },
  hardware: { Icon: Cpu, color: 'text-slate-500 dark:text-slate-400', label: 'IT & Hardware' },
}
